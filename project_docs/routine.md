...
- **Weekly Structure Rule**: Each week folder (e.g., `week-01`, `week-02`) must contain a strictly maximum of 8 days. If the week exceeds 8 days, start a new week folder (e.g., `week-04`) and move the exceeding days into it. All references in `dayTitle.md` must be updated accordingly.
