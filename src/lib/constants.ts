...
export const pricingCards = [
  {
    ...
    features: [
      ...
      { label: "Templates", available: false },
    ],
    priceId: "",
    amountInRupees: 0,
  },
  ...
  },
  {
    ...
    description: "The ultimate agency powerhouse",
    price: "₹2,999",
    duration: "month",
    ...
    features: [
      ...
      { label: "AI Funnel Editor & all templates", available: true },
      { label: "White labelling & rebilling", available: true },
      { label: "Custom domains · 24/7 Priority support", available: true },
    ],
