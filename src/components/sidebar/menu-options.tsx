...
const MenuOptions = ({
  ...
  return (
    <Sheet modal={false} {...openState}>
      <SheetTrigger
        asChild
        className="absolute left-4 top-4 z-40 md:hidden! flex size-8"
      >
      ...
      <SheetContent
        ...
        side="left"
        className={cn(
          "bg-background/80 backdrop-blur-xl fixed top-0 border-r p-2",
          {
            "hidden md:inline-block z-0 w-75": defaultOpen,
